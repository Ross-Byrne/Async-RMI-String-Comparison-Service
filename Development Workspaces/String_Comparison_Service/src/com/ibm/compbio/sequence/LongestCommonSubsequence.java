...
public class LongestCommonSubsequence extends DynamicProgramming {
    ...
    * (non-Javadoc)
    * 
    * @see com.com.ibm.compbio.seqalign.DynamicProgramming#getInitialPointer(int,
    *      int)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.com.ibm.compbio.seqalign.DynamicProgramming#getInitialScore(int, int)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see com.com.ibm.compbio.seqalign.DynamicProgramming#getTraceback()
    */
   @Override
